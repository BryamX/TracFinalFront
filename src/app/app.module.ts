...
import { JuegoAtrapaSenasComponent } from './Pages/juegos/juego-atrapa-senas/juego-atrapa-senas.component'; // Asegúrate de importarlo aquí
...
@NgModule({
  declarations: [
    ...
    JuegoAtrapaSenasComponent // Debería estar aquí en 'declarations'
  ],
  imports: [
    BrowserModule,
    AppRoutingModule,
